...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Praisecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  litecoind [options]                     " + "\n" +
                  "  litecoind [options] <command> [params]  " + _("Send command to -server or praisecoind") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 55885 or testnet: 45885)") + "\n" +
        ...
        // or testnet: 19332
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 55884)") + "\n" +
