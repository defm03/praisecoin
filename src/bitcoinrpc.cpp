...
void StartRPCThreads()
{
    ...
    // GetDefaultRPCPort() is changed to "55884s" port
    ip::tcp::endpoint endpoint(bindAddress, GetArg("-rpcport", "55884"));
...
Object CallRPC(const string& strMethod, const Array& params)
{
    ...
    // itostr(GetDefaultRPCPort() changed to "55884" port
    if (!d.connect(GetArg("-rpcconnect", "127.0.0.1"), GetArg("-rpcport", "55884"))))
